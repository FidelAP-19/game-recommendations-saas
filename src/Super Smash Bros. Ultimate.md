...
<h1>Nintendo Switch Games</h1>
    <section class="grid-m">
        <article class="card-m">
          ...
          <article class="card-m">
            <div class="card__img-m"><img src="/images/Super_Smash_Bros_cover.png" alt="Super Smash Bros. Ultimate"></div>
          </article>
     </section>
     <h1>Reviews</h1>
