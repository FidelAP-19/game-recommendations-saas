        ...
        <article class="card-m">
            <div class="card__content-m">
              ...
              <p class="card__text-m">
                Animal Crossing: New Horizons is a beloved life simulation game for the Nintendo Switch. Players escape to a deserted island and create their own paradise, where they can fish, catch bugs, decorate their home, and form relationships with charming animal villagers. With its relaxing gameplay, delightful customization options, and real-time events, Animal Crossing: New Horizons provides a joyful and immersive experience that keeps players engaged for hours on end.
              </p>
              <ul>
